...
int main() {
	...
	//sf::Music music;
	//sf::SoundBuffer opening;
	//music.openFromFile("Sounds/01 - Opening.wav");
	//std::string wav[3] = { "Sounds/01 - Opening.wav","Sounds/03 - Title Screen.wav" };
	sf::Music music;
