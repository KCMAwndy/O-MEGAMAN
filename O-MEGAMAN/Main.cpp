...
int main() {
	int enCount=0,score=0,megaHP=100,bossHp=300,minionSpeed=80,enballSpeed=150;
	int spawncount = 5;
	int *ptrenCount,*ptrScore,*ptrMegaHP,*ptrBossHP,*ptrminionSpeed, *ptrEnballSpeed;
	ptrenCount = &enCount;
	ptrScore = &score;
	ptrMegaHP = &megaHP;
	ptrBossHP = &bossHp;
	...
	while (window.isOpen()) {
		...
		//spawnClock = clock.restart().asSeconds();
